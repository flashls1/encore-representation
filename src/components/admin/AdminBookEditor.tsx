...
const AdminBookEditor = () => {
    ...
    useEffect(() => {
        if (bookContent) {
            setForm({
                page_title: bookContent.page_title || '',
                page_description: bookContent.page_description || '',
                hero_image_url: bookContent.hero_image_url || '',
                sections: Array.isArray(bookContent.sections) ? bookContent.sections : [],
            });
        }
    }, [bookContent]);
    ...
    const handleSave = async () => {
        ...
        try {
            const payload = {
                ...(bookContent?.id && { id: bookContent.id }),
                ...form,
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h3 className="text-lg font-bold text-foreground">Book Now Page</h3>
                    <p className="text-sm text-muted-foreground">Edit the Book Now page content, images, and layout.</p>
                </div>
